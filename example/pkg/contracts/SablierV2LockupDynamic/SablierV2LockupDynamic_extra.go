// Code generated by abisiggen.sh for SablierV2LockupDynamic; DO NOT EDIT.
...
// SablierV2LockupDynamicTopics contains event signatures for SablierV2LockupDynamic
type SablierV2LockupDynamicTopics struct {
	...
	CreateLockupDynamicStream common.Hash `json:"CreateLockupDynamicStream"` // 0xd039797d11a25bf11461e1e195f2b27f5b607e70d028498ee7119d4410b55229
...
// SablierV2LockupDynamicMethods contains method signatures for SablierV2LockupDynamic
type SablierV2LockupDynamicMethods struct {
	...
	CreateWithDurations    []byte `json:"CreateWithDurations"`    // 0x54c02292 (createWithDurations((address,address,uint128,address,bool,bool,(uint128,uint64,uint40))
	CreateWithTimestamps   []byte `json:"CreateWithTimestamps"`   // 0x31df3d48 (createWithTimestamps((address,address,uint128,address,bool,bool,uint40,(uint128,uint64,uint40))
...
// SablierV2LockupDynamicMethodNames contains method names with lowercase first letter
type SablierV2LockupDynamicMethodNames struct {
...
func InitSablierV2LockupDynamicTopics() SablierV2LockupDynamicTopics {
	return SablierV2LockupDynamicTopics{
		...
		CreateLockupDynamicStream: common.HexToHash("0xd039797d11a25bf11461e1e195f2b27f5b607e70d028498ee7119d4410b55229"),
...
func InitSablierV2LockupDynamicMethods() SablierV2LockupDynamicMethods {
	return SablierV2LockupDynamicMethods{
		...
		CreateWithDurations:    []byte{0x54, 0xc0, 0x22, 0x92},
		CreateWithTimestamps:   []byte{0x31, 0xdf, 0x3d, 0x48},
...
func InitSablierV2LockupDynamicMethodNames() SablierV2LockupDynamicMethodNames {
	return SablierV2LockupDynamicMethodNames{
